        ...
        <div class="card">
          <div class="card-body">
            ...
            <div>
              ...
              <span v-if="errorYear" class="error-message">La fecha de nacimiento es obligatoria</span>
            </div>
            <div>
            ...
            <button @click="register">Regístrate</button>            
          </div>
        </div>
      </div>
    </div>
...
export default defineComponent({
  setup() {
    ...
    localStorage.setItem('user', JSON.stringify(datosRegistrados.value))
